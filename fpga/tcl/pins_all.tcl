...
#     set_location_assignment PIN_M7   -to LEDS2[0]
#     set_location_assignment PIN_N8   -to LEDS2[1]
#     set_location_assignment PIN_N7   -to LEDS2[2]
#     set_location_assignment PIN_P7   -to LEDS2[3]
#     set_location_assignment PIN_R7   -to LEDS2[4]
#     set_location_assignment PIN_T7   -to LEDS2[5]
#     set_location_assignment PIN_L6   -to LEDS2[6]
#     set_location_assignment PIN_M6   -to LEDS2[7]
